...
--    o =  ({[{0, 1, 2, 4, 5, 3}, {0, NC, NC, 4, NC, NC}, {1, 2, 0}]}, 2)
-------------------------------------
...
--    o =  MutableHashTable{Board => [{5, 4, 3, 2, 1, 0}, {NC, NC, 5, 3, 1, NC}]}
...
--    	  Board =  [{4, 5, 3, 2, 1, 0}, {NC, NC, 5, 3, 1, NC}]
--    	  Children = {MutableHashTable{...5...}}
--    	  CriticalRow = 3
--        Fathers = {([{5, 4, 3, 2, 1, 0}, {NC, NC, 5, 3, 1, NC}], {2, 2, 0})}
--    	  IsResolved = false
--
-- playCheckers(G.Board, first first G.Fathers, last first G.Fathers, first Q.Children)
--    o =  MutableHashTable{Board => [{4, 5, 3, 2, 1, 0}, {NC, NC, 5, 3, 1, NC}]}
--                       Children => {MutableHashTable{...5...}}
--                       CriticalRow => 3
